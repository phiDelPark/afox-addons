...
define('_AF_LEDGER_DATA_TABLE_', 'afccc_ledger_data');
define('_AF_LEDGER_CATEGORY_TABLE_', 'afccc_ledger_category');
define('_AF_LEDGER_HISTORY_TABLE_', 'afccc_ledger_history');
